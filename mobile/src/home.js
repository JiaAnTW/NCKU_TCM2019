...
import home_pic from './asset/front_page_m.jpg';
import './home.css';
...
class home extends Component {
    ...
    changeText(){
        const textStyle={'textAlign':'left','position':'absolute','left':'5vw','width':'75vw'};
        ...
        return(
            ...
            *1/21 當天 11:00~11:30,會有專人接送你至報到地點<br/>
            ...
            二、搭乘高鐵:<br/>
            請轉搭沙崙支線至台南火車站後站<br/>
            並請事先聯絡我們,下高鐵後,在高鐵站搭乘沙崙支線至台南火車站,
            在台南火車站後站下車。<br/>
            *1/21 當天 11:00~11:30,會有專人接送你至報到地點。<br/>
            ...
            <br/>
            三、搭乘私人運具:<br/>
            可在成大光復校區門口下車(火車站後站的大學路上),校門口會有專人
            接送你至報到地點,沒趕上專人接送時間者,請循著隨信所附的地圖步
            行到成大。
            </p>
        );
    }
  ...
  render() {
    const ButtonStyle=[{top: "100vw"},{top: "115vw"},{top: "130vw"},{left:'28vw',top: "170vw"}];
    return (
      <div className="App">
