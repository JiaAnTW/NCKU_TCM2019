    ...
    return (
      <div className="container">
              ...
              <div className='Field_container'>
                  ...
                  <span className='truck_content'>物流(logistics)是有關商品、服務及相關訊息流動的一連串過程。在『物流管理』的領域將透過『供應鏈管理、倉儲與存貨管理、國際貿易、國際物流』介紹有關「物」的流動，像是商品在運送的過程、決定庫存的方法......</span>
                  <img src={network} className='network'  alt='network'/>
                  <h4 className='network_topic'>運輸科技</h4>
                  <span className='network_content'>所謂的『運輸科技』就是，結合資訊、通信、電子、控制等技術應用於運輸。像智慧腳踏車租借系統，就是便利且被廣泛應用的運輸科技實例之一!透過本系運輸科技的專業課程『運輸工程、智慧型運輸系統、管理資訊系統、交通流理論』，將會帶給大家更深入的了解和專業的相關知識哦</span>
                  <img src={tower} className='tower'  alt='tower'/>
                  <h4 className='tower_topic'>電信管理</h4>
                  <span className='tower_content'>在電管，你會廣泛了解網路和手機訊號傳遞的技術。但比起資/電工著重技術，電管更重視如何從定價策略、行銷、市場分析，去經營「提供電信技術的公司」。你需要在了解最新技術的同時，用宏觀的視野去看待技術和市場的關聯</span>
                  </div>
              </div>
